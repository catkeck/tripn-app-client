...
const DATA = [
  ...
  {label: 'Cardio Classes',value: 'cardioclasses'},
  {label: 'Dance Studios',value: 'dancestudio'},
  {label: 'EMS Training',value: 'emstraining'},
  ...
  {label: 'Veterans Organizations',value: 'veteransorganizations'},
  {label: 'Stadiums & Arenas',value: 'stadiumsarenas'},
  {label: 'Street Art',value: 'streetart'},
  {label: 'Studio Taping',value: 'studiotaping'},
  {label: 'Supernatural Readings',value: 'psychic_astrology'},
  {label: 'Astrologers',value: 'astrologers'},
  {label: 'Mystics',value: 'mystics'},
  {label: 'Psychic Mediums',value: 'psychicmediums'},
  ...
  {label: 'Bartending Schools',value: 'bartendingschools'},
  {label: 'Circus Schools',value: 'circusschools'},
  {label: 'Cooking Schools',value: 'cookingschools'},
  {label: 'Cosmetology Schools',value: 'cosmetology_schools'},
  {label: 'Language Schools',value: 'language_schools'},
  {label: 'Massage Schools',value: 'massage_schools'},
  {label: 'Ski Schools',value: 'skischools'},
  {label: 'Speech Training',value: 'speechtraining'},
  ...
  {label: 'Strip Clubs',value: 'stripclubs'},
  {label: 'Striptease Dancers',value: 'stripteasedancers'},
  ...
  {label: 'Dance Restaurants',value: 'dancerestaurants'},
